...
## Source :  
```
https://github.com/Lissy93/networking-toolbox.git

# Author : Alicia Sykes
# Site : https://www.aliciasykes.com/
```

## How to Run :  
```
git clone git@github.com:AZIZI-Sajjad/networking-toolbox.git
cd networking-toolbox 
docker compose --file ./docker-compose.yml --project-name networking-toolbo config
docker compose --file ./docker-compose.yml --project-name networking-toolbo up
docker compose --file ./docker-compose.yml --project-name networking-toolbo down
docker compose --file ./docker-compose.yml --project-name networking-toolbo logs -f
```
